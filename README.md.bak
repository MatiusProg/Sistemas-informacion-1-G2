# ?? Sistema de Gesti¨®n de Almacenes Gastron¨®micos - SI1

**Grupo 2 - INF342 - Semestre 1-2026**
**Universidad Aut¨®noma Gabriel Ren¨¦ Moreno**

## ?? Descripci¨®n
Sistema inteligente para gesti¨®n de almacenes gastron¨®micos con control de caducidad, merma, estacionalidad y proveedores. Desarrollado como proyecto acad¨¦mico para la materia INF342 - Sistemas de Informaci¨®n I.
...
## ??? Stack Tecnol¨®gico
| Capa | TecnologÃ­a | Justificaci¨®n |
|------|------------|---------------|
| **Frontend** | React + Vite + JavaScript | Exportable desde Lovable, hot-reload r¨¢pido |
| **Backend** | Django + Django REST Framework | ORM robusto, panel admin autom¨¢tico, baja curva |
| **Base de Datos** | Supabase (PostgreSQL) | PostgreSQL real, autenticaci¨®n integrada, gratis |
| **Autenticaci¨®n** | Supabase Auth | Ãšnica fuente de verdad, RLS nativo |
| **Hosting** | Railway (Plan Free â†?Hobby) | Sin cold starts, soporte nativo para Django |

## ?? Estructura del Proyecto
``` bash
©À©¤©¤ backend/ # Aplicaci¨®n Django (API REST)
©¦ ©À©¤©¤ venv/ # Entorno virtual (NO se sube a Git)
©¦ ©À©¤©¤ nucleo/ # Configuraci¨®n principal de Django
©¦ ©À©¤©¤ usuarios/ # App de autenticaci¨®n
©¦ ©À©¤©¤ manage.py # Comandos de Django
©¦ ©¸©¤©¤ requirements.txt # Dependencias Python
©À©¤©¤ frontend/ # Aplicaci¨®n React + Vite
©À©¤©¤ docs/ # Documentaci¨®n del proyecto
©¦ ©À©¤©¤ diagramas/ # Diagramas UML, Ishikawa, Relacionales
©¦ ©¸©¤©¤ informes/ # Avances, Entrevistas, An¨¢lisis
©¸©¤©¤ .github/ # Configuraci¨®n de CI/CD (futuro)
```
...
| Herramienta | Versi¨®n | Enlace de Descarga |
|-------------|---------|-------------------|
...
> ?? **IMPORTANTE (Windows):** Debes instalar **Microsoft C++ Build Tools** marcando la opci¨®n *"Desarrollo para escritorio con C++"*. Esto es necesario para compilar `pyiceberg`. Sin esto, la instalaci¨®n fallar¨¢.
...
9. **Probar en navegador:**
	...
	- Debe verse la p¨¢gina de bienvenida de Django (?? cohete).
